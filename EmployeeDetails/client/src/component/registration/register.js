...
export function Registration() {
    var handlesubmit = async (event) => {
        ...
        if (place === '' || place === 'null') {
            ...
            await axios.post("http://localhost:3307/insertdata", { name, place, role, salary, dat, phone, }, config)
                .then((res) => {
            ...
            <div className="backgrounpic">
                ...
                <div className="offset-lg-4  ">
                    <form onSubmit={handlesubmit} >
                        ...
                        <label className="w-25 p-3">Role</label>
                        : <input type="text" id="role" name="role" className="inputs p-2" required /><br />

                         <label className="w-25 p-3">Phone No</label>
                        : <input type="tel" id="phone" name="phone" className="inputs p-2" required /><br />   
